...
const Account = () => {
  ...
  const [pickedTimeSlotTime, setPickedTimeSlotTime] =
    useState("");
  ...
  // manipulate timeslot click to open
  // modal and populate selected timeslot

  const handleTimeSlotPress = (item) => {
    setModalVisible(true);
    setPickedTimeSlotTime(item.start_time);
    ...
    <SafeAreaView className=" w-full h-full bg-white ">
      <ScrollView className="h-full pt-6">
        ...
        <BookingModal
          ...
          pickedTimeSlotTime={pickedTimeSlotTime}
